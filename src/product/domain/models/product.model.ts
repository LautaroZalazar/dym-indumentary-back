...
export class ProductModel extends BaseModel {
    ...
    static hydrate(product: any): ProductModel {
        ...
        newProduct._size = product.size ? product.size.map((size) => CatSizeModel.hydrate(size)) : [];
        newProduct._color = product.color ? product.color.map((color) => CatColorModel.hydrate(color)) : [];
